/*
**	Multiple client processes and a single server process on the
**	localhost each exchange a single request/response message
**	passing sequence.
**
**	Arguments:	<port number> <number of clients>
**				[ <keyword=value pair> ... ]
**
**	@(#)egmessages3.c	4.3 95/12/24 jsloan@ncar.ucar.edu
*/
